...
namespace VoronoiTests
{
    ...
    public class SiteEventHandlerStrategyTest
    {
        ...
        public void TestHandleTwoEvents()
        {
            ...
            var edge = _strategy.HandleEvent(siteEvents[1], _eventQueue, _beachLine);

            Assert.IsNotNull(edge);
            Assert.AreEqual(siteEvents[0].Point, edge.Left);
            Assert.AreEqual(siteEvents[1].Point, edge.Right);
        }
